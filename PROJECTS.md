...
| Project | PC folder | VPS folder | GitHub repo | Notes |
|---|---|---|---|---|
| AI Agency / Job Market Digital | `D:\JAM AI Workspace\AI Agency` | `/home/hermes/projects/ai-agency` | https://github.com/arasal1009-web/ai-agency.git | Website-building business; domain `jobmarketdigital.com` |
...
Treat these as stale unless Jude explicitly says otherwise:

- `D:\A - Work`
- `C:\Users\Admin\Claude\Projects`
- `/home/hermes/wat-backup`
- `C:\Users\Admin\AI\wat-backup`

## Sub-agent setup status

See `/home/hermes/projects/jam-ai-workspace/agents/README.md` for the central sub-agent registry.
